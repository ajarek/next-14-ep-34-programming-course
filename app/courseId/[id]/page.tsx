  ...
  return (
    <div  className=' min-h-screen  pl-[280px] max-lg:pl-[24px] pr-[24px] py-24 flex flex-col justify-start items-center gap-4 '>
      ...
      <Image
        ...
        height={405}
      />
      <p className='place-self-start px-24  max-lg:px-0'>{course?.description}</p>
      <p className='flex gap-2 place-self-start px-24 max-lg:px-0'><Youtube color="red" />watch {course?.watch}</p>
      <p className='flex place-self-start px-24 max-lg:px-0 items-center'>price: <span className='font-semibold'>{course?.price}</span>  <DollarSign size={16} /></p>
